...
//DijetTreeProducer::DijetTreeProducer( const ParameterSet& cfg)
{
  ...
  */
  ...
  vector<string> disc_names = cfg.getParameter<vector<string> >("bDiscriminators"); 
...
void DijetTreeProducer::beginJob() 
{
  ...
  //------------------------------------------------------------------
  //DeepBtag
  deepFlavourJetTags_probudsg_ = new std::vector<float>;
  deepFlavourJetTag_probb_     = new std::vector<float>;
  deepFlavourJetTags_probc_    = new std::vector<float>;
  deepFlavourJetTags_probbb_   = new std::vector<float>;
  deepFlavourJetTags_probcc_   = new std::vector<float>;
  //DeepBtag
  ...
  */
  ...
  //DeepBtag
  outTree_->Branch("deepFlavourJetTags_probudsg" ,"vector<float>",&deepFlavourJetTags_probudsg_);
  outTree_->Branch("deepFlavourJetTag_probb"     ,"vector<float>",&deepFlavourJetTag_probb_);
  outTree_->Branch("deepFlavourJetTags_probc_"   ,"vector<float>",&deepFlavourJetTags_probc_);
  outTree_->Branch("deepFlavourJetTags_probbb_"  ,"vector<float>",&deepFlavourJetTags_probbb_);
  outTree_->Branch("deepFlavourJetTags_probcc_"  ,"vector<float>",&deepFlavourJetTags_probcc_);
  //DeepBtag
...
{  
  ...
  //DeepBtag
  delete deepFlavourJetTags_probudsg_;
  delete deepFlavourJetTag_probb_;
  delete deepFlavourJetTags_probc_;
  delete deepFlavourJetTags_probbb_;
  delete deepFlavourJetTags_probcc_;
  //DeepBtag
...
void DijetTreeProducer::initialize()
{
  ...
  deepFlavourJetTags_probudsg_  ->clear();
  deepFlavourJetTag_probb_      ->clear();
  deepFlavourJetTags_probc_     ->clear();
  deepFlavourJetTags_probbb_    ->clear();
  deepFlavourJetTags_probcc_    ->clear();
  ptAK4_             ->clear();
  etaAK4_            ->clear();
  phiAK4_            ->clear();
  massAK4_           ->clear();
